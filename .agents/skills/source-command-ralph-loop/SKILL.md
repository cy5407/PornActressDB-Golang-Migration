...
### 1. 讀取任務清單
首先閱讀 `.Codex/ralph-fix-plan.md` 了解當前任務優先級和進度。
...
### 4. 更新進度
完成任務後：
1. 在 `.Codex/ralph-fix-plan.md` 標記 `- [x]`
2. 更新 `AGENTS.md` 架構說明（如需要）
...
- 專案架構: `AGENTS.md`
- 詳細指引: `.Codex/ralph-golang-migration.md`
- 建置命令: `.Codex/ralph-agent-golang.md`
