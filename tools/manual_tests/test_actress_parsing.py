...
test_cases = [
    ...
    (['水卜さくら #音羽美鈴'], (['水卜さくら', '音羽美鈴'], True), '合併名稱（# 分隔）'),
    (['柏木こなつ #胡桃さくら #高瀬りな'], (['柏木こなつ', '胡桃さくら', '高瀬りな'], True), '3位女優合併'),
    (['如月りいさ #小那海あや #美澄玲衣 #逢月ひまり'], 
     (['如月りいさ', '小那海あや', '美澄玲衣', '逢月ひまり'], True), '4位女優合併'),
]
...
if all_passed:
    print("✅ 所有測試通過！")
    print("\n📌 重要發現:")
    print("1. classifier_core.py 的 _parse_actresses_list() 會自動處理 # 分隔的女優名稱")
